        ...
        <>
            <div className="max-w-2xl mx-auto mt-2">
                ...
                <p className={'text-lg text-center text-muted-foreground text-balance mb-8 max-w-2xl mx-auto'}>
                    ...
                    and we will generate and post it for you
                </p>
                <Carousel plugins={[
                    Autoplay({
                        delay: 3000,
                    ...
                    <CarouselContent>
                        <CarouselItem>
                            <Image width={'1536'} height={'1024'} src={'/cards/postcard-prank.png'}
                                   alt={'postcard prank'}/>
                        </CarouselItem>
                        <CarouselItem>
                            <Image width={'1536'} height={'1024'} src={'/cards/postcard-proposal.png'}
                                   alt={'postcard for a proposal'}/>
                        </CarouselItem>
                        <CarouselItem>
                            <Image width={'1536'} height={'1024'} src={'/cards/postcard-fathers.png'}
                                   alt={'postcard for fathers day'}/>
                        </CarouselItem>
                    </CarouselContent>
            ...
            <div className={'max-w-2xl mx-auto mt-8'}>
                <form className={'flex flex-col gap-y-4'}>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <p className="text-xs text-gray-500 mb-1">Be descriptive about what you'd like to see on your
                            postcard</p>
                        <Textarea
                            id="prompt"
                            name="prompt"
                    ...
                    {hasRequestedOtp &&
                        <div className="space-y-3 mt-2 p-4 bg-blue-50 rounded-lg border border-blue-100 text-center">
                    ...
                    <div className="mt-4">
                        ...
                        {(hasRequestedOtp || user) && <Button
                            ...
                            {(isUserLoading || isCustomerSessionLoading) ?
                                <><Loader2Icon className="animate-spin mr-2"/> Please
                                    wait</> : user ? 'Create My Postcard' : 'Verify & Continue'}
                        </Button>}
                    </div>
                </form>
            </div>
